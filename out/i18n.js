...
exports.en = exports.ja = void 0;
exports.getCurrentLocale = getCurrentLocale;
exports.setCurrentLocale = setCurrentLocale;
exports.t = t;
exports.tLocale = tLocale;
const SUPPORTED_LOCALES = ['en', 'ja', 'de', 'es', 'fr', 'it', 'ko', 'pt-br', 'ru', 'zh-cn', 'zh-tw'];
...
function t(key, ...args) {
    ...
    let text = translations[key] ?? exports.en[key] ?? exports.ja[key] ?? key;
    args.forEach((arg, i) => {
...
function tLocale(locale, key, ...args) {
